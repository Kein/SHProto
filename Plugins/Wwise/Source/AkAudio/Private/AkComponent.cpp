...
int32 UAkComponent::PostAkEventAndWaitForEnd(UAkAudioEvent* AkEvent, const FString& in_EventName, FLatentActionInfo LatentInfo, bool bAllowPositionTracking) {
    return 0;
}

bool UAkComponent::IsPlaying() const {
    return false;
}

float UAkComponent::GetPlaybackTime(int32 PlayingID) {
    return 0.0f;
}
