...
public:
    ...
    UFUNCTION(BlueprintCallable, meta=(Latent, LatentInfo="LatentActionInfo"))
    int32 PostOnComponentAndWait(UAkComponent* Component, const bool bStopWhenAttachedObjectDestroyed, const FLatentActionInfo LatentActionInfo, bool bAllowPositionTracking);
