...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static UAkComponent* SpawnAkComponentAttachedEx(USceneComponent* BaseComponent, UAkAudioEvent* AkEvent, FVector Location, FRotator Orientation, bool AutoPost, const FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta=(WorldContext="WorldContextObject"))
    static UAkComponent* SpawnAkComponentAtLocationEx(UObject* WorldContextObject, UAkAudioEvent* AkEvent, FVector Location, FRotator Orientation, bool AutoPost, const FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta=(WorldContext="WorldContextObject"))
    static UAkComponent* SpawnAkComponentAtLocation(UObject* WorldContextObject, UAkAudioEvent* AkEvent, FVector Location, FRotator Orientation, bool AutoPost, const FString& EventName, bool AutoDestroy, bool bAllowPositionTracking);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SetRTPCValueByPlayID(const FString& RTPCName, float RTPCValue, int32 PlayID, int32 InterpolationTimeMs);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool SetOfflineRenderingFrameTime(float FrameTimeInSeconds);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool SetOfflineRendering(bool bEnable);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 SeekOnEvent(const FString& in_EventName, UAkComponent* in_pComponent, float in_fPercent, bool in_bSeekToNearestMarker, int32 InPlayingID);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool RenderNextNonRealtimeAudioFrame();
    ...
    UFUNCTION(BlueprintCallable)
    static UAkComponent* GetAkComponentEx(USceneComponent* AttachToComponent, bool& ComponentCreated, FName AttachPointName, FVector Location, TEnumAsByte<EAttachLocation::Type> LocationType, float CreatedComponentOcclusionRefreshInterval, bool bCreatedComponentAutoDestroy);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 ComponentSeekOnEvent(UAkComponent* in_pComponent, float in_fPercent, bool in_bSeekToNearestMarker, int32 InPlayingID);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 CheckPadHeadphonesStatus();
