...
public:
    ...
    UPROPERTY(Config, EditAnywhere)
    bool OcclusionIgnorePawnAttachedActors;
    ...
    UPROPERTY(Config, EditAnywhere)
    float MaxObstructionOcclusionPortalTraceDist2D;
    
    UPROPERTY(Config, EditAnywhere)
    TSoftClassPtr<AAkAmbientSound> SpawnAkAmbientSoundClass;
    
    UPROPERTY(Config, EditAnywhere)
    TSoftClassPtr<UAkComponent> SpawnAkComponentClass;
    
    UPROPERTY(Config, EditAnywhere)
    TSoftObjectPtr<UAkAudioEvent> MusicPlayEvent;
    
    UPROPERTY(Config, EditAnywhere)
    TArray<FName> MusicSwitchesFolderPaths;
